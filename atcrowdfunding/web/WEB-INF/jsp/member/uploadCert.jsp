            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a  class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> 张三<span class="caret"></span></a>
...
<div class="container theme-showcase" role="main">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a ><span class="badge">3</span> 邮箱确认</a></li>
        <li role="presentation"><a ><span class="badge">4</span> 申请确认</a></li>
    </ul>
    ...
    <form id="uploadCertForm" style="margin-top:20px;" method="post" enctype="multipart/form-data">
            ...
            <c:forEach items="${queryCertByAcctType}" var="cert" varStatus="status">
                ...
                <div class="form-group">
                    ...
                    <input id="name" type="file" name="certimgs[${status.index}].fileImg" class="form-control" >
                    <br>
        ...
        var options = {
            ...
            success : function (result) {
                ...
                if (result.success){
                    ...
                    layer.msg("数据保存失败！",{time:1000,icon:6,shift:6});
                }
            }
        };
