...
<div class="container">
    <form id="loginForm" action="${APP_PATH}/doLogin.do" method="POST" class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="floginacct" value="zhangsan" name="loginacct"  placeholder="请输入登录账号" autofocus>
...
<script>
    ...
    function dologin() {
        ...
        $.ajax({
            ...
            beforeSend : function(){
                var loadingIndex = layer.msg("正在登录",{icon:16});
                //表单数据校验
                return true;
            },
