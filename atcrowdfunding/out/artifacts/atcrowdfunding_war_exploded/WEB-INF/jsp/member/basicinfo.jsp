            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="${APP_PATH}/#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> 张三<span class="caret"></span></a>
...
<div class="container theme-showcase" role="main">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="${APP_PATH}/#"><span class="badge">1</span> 基本信息</a></li>
        <li role="presentation"><a href="${APP_PATH}/#"><span class="badge">2</span> 资质文件上传</a></li>
        <li role="presentation"><a href="${APP_PATH}/#"><span class="badge">3</span> 邮箱确认</a></li>
        <li role="presentation"><a href="${APP_PATH}/#"><span class="badge">4</span> 申请确认</a></li>
    </ul>
