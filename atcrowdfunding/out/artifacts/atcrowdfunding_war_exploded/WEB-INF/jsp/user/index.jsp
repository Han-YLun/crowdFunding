    ...
    <script src="${APP_PATH }/script/common.js"></script>
        <script type="text/javascript">
					...
					success : function (result) {
						...
						if (result.success){
							...
							$.each(data,function (i,n) {
								...
								content+='<td>';
								content+='<button onclick="window.location.href=\'${APP_PATH}/user/assignRole.htm?id='+n.id+'\'" type="button" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
								content+='<button onclick="window.location.href=\'${APP_PATH}/user/toUpdate.htm?id='+n.id+'\'" type="button" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
								content+='<button onclick="deleteUser('+n.id+',\''+n.loginacct+'\')" type="button" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
								content+='</td>';
								content+='</tr>';
							});
							$("tbody").html(content);
							...
							layer.msg(result.message,{time:100,icon:5,shift:6});
						}
					},
					error : function () {
					...
					$.ajax({
						...
						success : function (result) {
							if (result.success){
								...
								layer.msg("删除用户失败",{time:100,icon:5,shift:6});
							}
						},
						error : function () {
			...
			$("#allCheckbox").click(function () {
				...
				//$("tbody tr td input[type='checkbox']").attr("checked",isChecked);
